...
import 'package:idk/metadata_sliver.dart';
import 'package:idk/platforn_specific/android.dart';
import 'package:idk/remote_messages_widget.dart';
import 'package:idk/stateful_widget_example.dart';
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      ...
      final unsubscribeOnMessage = Push.instance.addOnMessage((message) {
        ...
        // use the state to show local notification.
