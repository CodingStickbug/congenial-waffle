...
import 'package:winotif/templates/alarm_template.dart';
import 'package:path_provider/path_provider.dart';
import 'package:http/http.dart' as http;
import 'package:winotif/templates/meeting_template.dart';
...
class _MyAppState extends State<MyApp> {
  Future<String> getImageBytes(String url) async {
    ...
    final imageFile = File(
      "${supportDir.path}/${DateTime.now().millisecond}.png",
    );
  ...
  final _winNotifyPlugin = WindowsNotification(
    applicationId:
        r"{D65231B0-B2F1-4857-A4CE-A8E7C6EA7D27}\WindowsPowerShell\v1.0\notesapp.exe",
  );
